...
export function TransactionButton({type, isSelected}: TransactionButtonProps) {
    ...
    return (
        <div className={`flex flex-col h-[56px] w-[236px] rounded-md ${bgColor} border-[1.5px] border-transaction-border cursor-pointer`}>
